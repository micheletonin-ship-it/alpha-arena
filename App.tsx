...
const AppContent: React.FC = () => {
  ...
  if (!currentUser) {
    ...
    if (isMobile) {
      ...
      // Pass initialMode based on mobileView to open correct form
      return <Login onLogin={handleLogin} theme={theme} isLoading={isLoadingAuth} fromLanding={true} initialMode={mobileView} />;
    }
